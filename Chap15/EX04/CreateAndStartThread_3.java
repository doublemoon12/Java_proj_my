...
//Runnable 인터페이스의 run()을 구현해서 쓰래드 생성 
class SMIFileRunnable implements Runnable { // 인터페이스이기 떄문에 implements
	@Override
	public void run() {
		// 1. 자막 번호 출력
...
public class CreateAndStartThread_3 {
	...
	public static void main(String[] args) {
		...
		Thread thread = new Thread(smi);	//Runnable객체를 Tread생성자 내부에 넣는다
		thread.start();
