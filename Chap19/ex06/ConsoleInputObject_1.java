...
/*
 * System.in	: Console에서 인풋을 받는 자바에서 제공해주는 객체, InptStream
 * 			Windows	: 콘솔에서 Enter	: \n\r
 * 			Mac		: 콘솔에서 Enter	: \r
 * System.out	: Console로 출력을하는 객체, OutputStream
 */
...
public class ConsoleInputObject_1 {
	...
	public static void main(String[] args) throws IOException {
		...
		//1. Console에서 인풋 받기 위한 객체 생성.
		InputStream is1 = System.in;	//is1은 콘솔에서 인풋받아서 처리하는 객체
		
		System.out.println("영문을 입력 하세요. >>>");
		
		int data;
		
		while((data = is1.read()) != '\r') {	//1byte읽어서 int data 변수에 할당.
